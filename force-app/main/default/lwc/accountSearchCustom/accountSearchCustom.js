...
import findRecords from "@salesforce/apex/LwcLookupControllerCust.findAccRecords"; 
...
export default class accountSearchCustom extends LightningElement {  
    @track recordsList;  
   ...
   console.log('deliveryAgencyEvent ID in custom lookup: '+ this.orderagency);
    ...
    onSeletedRecordUpdate(){  
        ...
        this.dispatchEvent ( 
            new CustomEvent('accountselection', {  
