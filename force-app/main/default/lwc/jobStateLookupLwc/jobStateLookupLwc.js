...
export default class JobStateLookupLwc extends LightningElement {  
    @track recordsList;  
    ...
    onRecordSelection(event) {  
     ...
     this.jobstate = this.selectedValue;
     console.log("Selected Record" + this.selectedRecordId);
     console.log("Selected Job State/Province value: " + this.jobstate);
     this.searchKey = "";  
     this.onSeletedRecordUpdate();  
     this.passItemListToParent2();
    }  
   ...
   console.log('deliveryAgencyEvent ID in custom lookup: '+ this.orderagency);
    ...
    passItemListToParent2(){
      console.log('Passing Event');
      const selectedEvent2 = new CustomEvent("jobstatelookupchange", {
          detail: this.jobstate
      });
