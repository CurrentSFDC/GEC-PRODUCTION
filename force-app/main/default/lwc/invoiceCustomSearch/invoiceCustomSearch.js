...
import findRecords from "@salesforce/apex/LwcLookupControllerCust.findInvRecords"; 
//import CommunityAccountSelector from '../communityAccountSelector/communityAccountSelector';

export default class invoiceCustomSearch extends LightningElement {  
    @track recordsList;  
    ...
    @api filterFieldName;
    @api filterFieldVal;  
    @api iconName = "standard:partner_fund_claim";  
    @api lookupLabel; 
    @api orderagency; 
    @track message;  
