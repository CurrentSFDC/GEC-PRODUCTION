...
export default class ProdSelectionManualEntryLwc extends LightningElement {
    @api columnList;
    @api title;
    //@track columns;
    @track objectAPIName;    
    ...
    async handleSave(event){     
       ...
       // console.log('Material ID: '+this.materialID);
        ...
        let nReturnItem = {'sobjectType': 'Return_Order_Item__c'};
            ...
            nReturnItem.Selected_Qty__c = this.selectQty;
            nReturnItem.Type__c = 'Pricing Inquiry - Manual Entry'
        ...
        getReturnProdList({transId : transaction})
            .then(result =>{
                ...
                this.dispatchEvent(
                    ...
                    this.dispatchEvent(
                        new CustomEvent('updatecartlines', {
                            detail: {
                                updateCart : true
                            }
                        }));
