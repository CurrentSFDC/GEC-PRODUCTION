({
     ...
     getInvoiceData : function(component, event, helper) {        
        ...
        if (params) {
            ...
            var param1 = params.invoiceNumber;
            // console.log('param1' + param1);                    
        
            return new Promise($A.getCallback(function (resolve, reject) {
                var action = component.get("c.getInvoicePDF");
                //action.setParams({"invNumber" : "1171070023" });
                action.setParams({"invNumber" : param1 });
                ...
                action.setCallback(this,function(response){ 
                    ...
                    if(state === "SUCCESS"){
                        ...
                        // console.log('Error (invoicepdfhelper)');
                        ...
                        if (errors) {
                            ...
                            helper.addPageMessage(component, "error", "There was a problem returning the Invoice data. Please contact your GE Current for help.");
                        }
                    }
                });            
