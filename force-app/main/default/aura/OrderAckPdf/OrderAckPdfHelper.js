({
    ...
    getPDFData : function(component, event, helper) {        
       ...
       if (params) {
           ...
           var param1 = params.ordNumber;
           // console.log('param1' + param1);                    
       
           return new Promise($A.getCallback(function (resolve, reject) {
               var action = component.get("c.getPDF");
               //action.setParams({"ordNumber" : "885839" });
               action.setParams({"ordNumber" : param1 });
               ...
               action.setCallback(this,function(response){ 
                   ...
                   if(state === "SUCCESS"){
                    ...
                    //    console.log('Error (orderackpdfhelper)');
                       ...
                       if (errors) {
                           ...
                           helper.addPageMessage(component, "error", "There was a problem returning the Order Confirmation Pdf data. Please contact your GE Current for help.");
                       }
                   }
               });            
