({
    ...
    getPDFData : function(component, event, helper) {        
       ...
       if (params) {
           ...
           var param1 = params.deliveryNotesNumber;
           // console.log('param1' + param1);                    
       
           return new Promise($A.getCallback(function (resolve, reject) {
               var action = component.get("c.getPDF");
               //action.setParams({"invNumber" : "0052033962" });
               ...
               action.setCallback(this,function(response){ 
                   ...
                   if(state === "SUCCESS"){
                       ...
                       if (errors) {
                           ...
                           helper.addPageMessage(component, "error", "There was a problem returning the Delivery Notes Pdf data. Please contact your GE Current for help.");
                       }
                   }
               });            
