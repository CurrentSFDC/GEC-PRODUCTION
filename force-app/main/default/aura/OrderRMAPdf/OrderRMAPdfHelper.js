    ...
    getPDFData : function(component, event, helper) {        
       ...
       if (params) {
           ...
           return new Promise($A.getCallback(function (resolve, reject) {
                // console.log('rma pdf controller');
               var action = component.get("c.getPDF");
               //action.setParams({"ordNumber" : "40132490" });
               ...
               action.setCallback(this,function(response){ 
                   ...
                   if(state === "SUCCESS"){
                       ...
                       if (errors) {
                           ...
                           helper.addPageMessage(component, "error", "There was a problem returning the RMA Pdf data. Please contact your GE Current for help.");
                       }
                   }
               });            
